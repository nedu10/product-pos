...
exports.adminOrderView = (req, res, next) => {
    Order.find()
    ...
    .then(response => {
        ...
        return res.render('admin/orders/order-view',{
            title: 'product-pos',
...
exports.adminAcceptOrder = (req, res, next) => {
    Order.update({_id: req.params.order_id}, {$set: {status: true}})
    .exec()
    .then(response => {
        console.log(response)
        return res.redirect('/order/admin-view')
    })
    .catch(err => {
        console.log(err)
        throw err
...
exports.adminRemoveOrder = (req, res, next) => {
    Order.update({_id: req.params.order_id}, {$set: {status: false}})
    .exec()
    .then(response => {
        console.log(response)
        return res.redirect('/order/admin-view')
...
exports.adminDeleteOrder = (req, res, next) => {
...
exports.orderCheckout = (req, res, next) => {
    if (req.session.buy) {
